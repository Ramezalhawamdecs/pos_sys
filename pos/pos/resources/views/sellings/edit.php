...
<input type="hidden" name="id" value="<?= $data->item->id ?>">
    <div class="mb-3">
        ...
        <input type="text" class="form-control" readonly disabled id="item-name" name="item_name" value="<?= $data->item->item_name ?>">
    </div>
    <div class="mb-3">
        <label for="user-email" class="form-label">price</label>
        <input type="price" class="form-control" id="user-price" name="selling_price" value="<?= $data->item->selling_price ?> JOD">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" readonly disabled id="quantity-email" name="total" value="<?= $data->item->total ?> JOD">
    </div>
