...
<button id="add-item" class="btn btn-success" ><i class="fa-regular fa-square-plus"></i></button>
</div>
</form>
<hr class="pt-0 pb-2">
    <br>
    <div id="dataTableContainer">
        <table class="table table-hover w-75 m-auto">
            ...
            <tbody>
                ...
                <td ><a class="btn btn-warning" href="/selling/edit?id=<?= $item->id?>">update</a></td >   
                </tr>
                <?php endforeach; ?>
            </tbody>
        </table>
