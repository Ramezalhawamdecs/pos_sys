...
<input type="hidden" name="id" value="<?= $data->datas->id ?>">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="item-title" name="selling_price" value="<?= $data->datas->selling_price ?>">
    </div>
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="item-title" name="total" value="<?= $data->datas->total?>" readonly> 
    </div>
